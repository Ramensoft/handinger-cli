...
import (
	...
	"github.com/Ramensoft/handinger-cli/pkg/cmd"
...
func main() {
	...
	if baseURL, ok := os.LookupEnv("HANDINGER_BASE_URL"); ok {
		if err := cmd.ValidateBaseURL(baseURL, "HANDINGER_BASE_URL"); err != nil {
